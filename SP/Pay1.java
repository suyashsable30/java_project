...
import javax.swing.*;
public class Pay1 extends Frame implements ActionListener
{ 
	Label l1;
	TextField t1;
	Button b1,b2,b3,b4;
	int seat,cal;
	String xx,yy,zz;
	public Pay1(String aa,String bb,String cc,int seats,int calc)
	{
	setLayout(new BorderLayout());
	JLabel background =new JLabel(new ImageIcon("33.jpg"));
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==b4)
		{	
			suya1 S1=new suya1(xx,yy,zz,seat,cal);
			setVisible(false);
		}
