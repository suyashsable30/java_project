...
import javax.swing.*;
public class Pay4 extends Frame implements ActionListener
{ 
	Label l1;
	TextField t1;
	Button b1,b2,b3,b4;
	int seat,cal;
	String xx,yy,zz;
	public Pay4(String aa,String bb,String cc,int seats,int calc)
	{
	setLayout(new BorderLayout());
	JLabel background =new JLabel(new ImageIcon("77.jpg"));
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==b4)
		{	
			suya4 S4=new suya4(xx,yy,zz,seat,cal);
			setVisible(false);
		}
		repaint();
	}
