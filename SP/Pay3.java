...
import javax.swing.*;
public class Pay3 extends Frame implements ActionListener
{ 
	Label l1;
	TextField t1;
	Button b1,b2,b3,b4;
	int seat,cal;
	String xx,yy,zz;
	public Pay3(String aa,String bb,String cc,int seats,int calc)
	{
	setLayout(new BorderLayout());
	JLabel background =new JLabel(new ImageIcon("55.jpg"));
	//set background(new Color(166, 156, 211));
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==b4)
		{	
			suya3 S3=new suya3(xx,yy,zz,seat,cal);
			setVisible(false);
		}
		repaint();
	}
